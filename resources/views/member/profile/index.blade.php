            ...
            <div class="col-lg-3 mb-3">
                <div class="sign-user_card text-center">
                    ...
                    <h4 class="mb-3">{{$user->name}}</h4>
                       ...
                       <a href="{{route('member.auth.settings',[app()->getLocale()])}}" class="edit-icon text-primary"><i class="fa fa-pencil" style="background-color: white;color:red; padding:5px 7px;border-radius: 50px;"></i></a>
                </div>
            </div>
            <div class="col-lg-9">
                            ...
                            <div style="overflow-x:auto;">
                                <table class="table text-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('frontend.details', [app()->getLocale(),$ticket->medias->slug]) }}" type="button" class="btn-sm btn-info">Details</a>
                                        </td>

  ...
  <!-- Sign in Start -->
               ...
               <div class="sign-user_card "> 
                  <div class="sign-in-page-data">
                     <div class="sign-in-from w-100 m-auto">
                        ...
                        <form class="mt-4">
                            ...
                            <a href="javascript:void(0)" id="getcode" class="btn btn-dark btn-sm sendOTP" onclick="sendMemberOtp()">Get Code</a>
                  ...
                  <div class="mt-3">
                     <div class="d-flex justify-content-center links">
                        Don't have an account? <a href="{{ route('member.auth.register',[app()->getLocale()]) }}" class="text-primary ml-2">Sign Up</a>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <script type="text/javascript">
        ...
        function sendMemberOtp(){
            ...
            $.ajax({
                data : { phone : phone},
				url: "{{ route('send.otp',[app()->getLocale()]) }}",
                method:'GET',
                type:'JSON',
            ...
            $('#verifPhNum').on('click', function() {
                ...
                .then(function (result) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('en/save/otp/code') }}",
                        method: "get",
                        data: {phone:phone},
                        success:function(data){
                            window.location.href = "{{ url('en/home') }}"; 
                        }
                    })

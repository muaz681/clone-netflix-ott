            ...
            <div class="row">
                <div class="col-md-12">
                    <div>
                        ...
                        <p>Welcome to Cinebaz!</p>
        
                        <p>These terms and conditions outline the rules and regulations for the use of Cinebaz Limited's Website,
                            located at cinebaz.com.</p>
        
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Cinebaz
                        ...
                        <p>We employ the use of cookies. By accessing Cinebaz, you agreed to use cookies in agreement with the
                            Cinebaz Limited's Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, Cinebaz Limited and/or its licensors own the intellectual property rights for
                            all material on Cinebaz. All intellectual property rights are reserved. You may access this from Cinebaz
                            for your own personal use subjected to restrictions set in these terms and conditions.</p>
        
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from Cinebaz</li>
                            <li>Sell, rent or sub-license material from Cinebaz</li>
                            <li>Reproduce, duplicate or copy material from Cinebaz</li>
                            <li>Redistribute content from Cinebaz</li>
                        </ul>
        
        
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                            certain areas of the website. Cinebaz Limited does not filter, edit, publish or review Comments prior to
                            their presence on the website. Comments do not reflect the views and opinions of Cinebaz Limited,its
                            agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                            opinions. To the extent permitted by applicable laws, Cinebaz Limited shall not be liable for the
                        ...
                        <p>Cinebaz Limited reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant Cinebaz Limited a non-exclusive license to use, reproduce, edit and authorize others to
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                            ...
                            absence of Cinebaz Limited; and (d) the link is in the context of general resource information.</p>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                            website, you must inform us by sending an e-mail to Cinebaz Limited. Please include your name, your
                        ...
                        <p>No use of Cinebaz Limited's logo or other artwork will be allowed for linking absent a trademark license
                            agreement.</p>

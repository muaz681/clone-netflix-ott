    ...
    <section class="single-page">
        <div class="container container-sp">
            <div class="row">
                <div class="col-md-12">
                    <div>
                        <h2>Privacy Policy for Cinebaz Limited</h2>
        
                        <p>At Cinebaz, accessible from cinebaz.com, one of our main priorities is the privacy of our visitors. This
                            Privacy Policy document contains types of information that is collected and recorded by Cinebaz and how
                            we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                            regards to the information that they shared and/or collect in Cinebaz. This policy is not applicable to
                            any information collected offline or via channels other than this website. Our Privacy Policy was
                        ...
                        <p>Cinebaz follows a standard procedure of using log files. These files log visitors when they visit
                        ...
                        <p>Like any other website, Cinebaz uses 'cookies'. These cookies are used to store information including
                        ...
                        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Cinebaz.</p>
        
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                            used in their respective advertisements and links that appear on Cinebaz, which are sent directly to
                        ...
                        <p>Note that Cinebaz has no access to or control over these cookies that are used by third-party
                            advertisers.</p>
        
                        <h2>Third Party Privacy Policies</h2>
        
                        <p>Cinebaz's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                        ...
                        <p>Cinebaz does not knowingly collect any Personal Identifiable Information from children under the age of

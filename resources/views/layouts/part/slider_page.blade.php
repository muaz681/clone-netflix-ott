...
<section id="home" class="iq-main-slider p-0">
    <div id="home-slider" class="slider m-0 p-0">
        ...
        <div class="slide slick-bg s-bg-1" style="background-image: url('{{ asset($list->featuredL ? 'storage/' . $list->featuredL->full : 'https://cdn.designcrowd.com/blog/2018/March/50-Typographic-Oscars-Film-Posters/GR_Typographic-Oscar-Film-Posters_Banner_828x300.jpg') }}'); height: 100vh;">

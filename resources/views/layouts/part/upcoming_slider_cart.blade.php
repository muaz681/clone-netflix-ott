                ...
                @if ($sdata->premium == 1)
                    <div class="movie-time d-flex align-items-center my-2">
                        ...
                        <span class="text-white"
                            style="text-decoration: line-through;font-size: 12px;">{{ $sdata->regular_price ? $sdata->regular_price : null }}</span>
                        <span class="text-white">{{ $sdata->discount_price ? '/' . $sdata->discount_price : null }}
                            {{ PayCurrency() }}</span>
                    </div>
                @endif

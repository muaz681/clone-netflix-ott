                                        ...
                                        <h1 class="slider-text big-title title text-uppercase"
                                            ...
                                            <div class="p-btns">
                                                <div class="d-flex align-items-center p-0">
                                                    <a href="{{ route('frontend.details', [app()->getLocale(),$slider['data'][0]->media->slug]) }}" class="btn btn-hover mr-2" tabindex="0"><i
                                                ...
                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                    ...
                                                    <div class="e-item">
                                                        <div class="block-image position-relative">
                                                            <a href="{{ route('frontend.details', [app()->getLocale(),$trand->slug]) }}">
                                                            @if($trand)
                                                                @if($trand->featured)
                                                            ...
                                                            <div class="episode-play-info">
                                                                <div class="episode-play">
                                                                    <a href="{{ route('frontend.details', [app()->getLocale(),$trand->slug]) }}" tabindex="0"><i class="ri-play-fill"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="episodes-description text-body mt-2">
                                                            <div class="d-flex align-items-center justify-content-between">
                                                            <a href="{{ route('frontend.details', [app()->getLocale(),$trand->slug]) }}">{{$trand->title_en}}</a>
                                    ...
                                    <div id="trending-data4" class="overlay-tab tab-pane fade">
                                        <div
                                            ...
                                            <div class="episodes-contens mt-4">
                                                ...
                                                <div class="e-item">
                                                    <div class="block-image position-relative">
                                                        <a href="{{ route('frontend.details', [app()->getLocale(),$trand->media->slug]) }}">
                                                        ...
                                                        <div class="episode-play-info" style="left: 25%;">
                                                            ...
                                                            <!-- <div class="episode-play">
                                                                <a href="{{ route('frontend.details', [app()->getLocale(),$trand->media->slug]) }}" tabindex="0"><i class="ri-play-fill"></i></a>
                                                            </div> -->
                                                        </div>
                                                    </div>
                                                    <div class="episodes-description text-body mt-2">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                        <a href="{{ route('frontend.details', [app()->getLocale(),$trand->media->slug]) }}">{{$trand->media->title_en}}</a>

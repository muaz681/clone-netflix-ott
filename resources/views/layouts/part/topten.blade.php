        ...
        <div class="row">
            <div class="col-sm-12 overflow-hidden">
                ...
                <ul id="top-ten-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                    ...
                    <li>
                        <a href="{{ route('frontend.details', [app()->getLocale(),$topTen->media->slug]) }}">
                ...
                <div class="vertical_s">
                    ...
                    @foreach($slider['data'] as $top)
                        <li>
                            ...
                            <a href="{{ route('frontend.details', [app()->getLocale(),$top->media->slug]) }}">
                            ...
                            <div class="block-description">
                                ...
                                <div class="hover-buttons">
                                    <a href="{{ route('frontend.details', [app()->getLocale(),$top->media->slug]) }}" class="btn btn-hover" tabindex="0">

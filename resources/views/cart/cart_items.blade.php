                        ...
                        <a href="#" class="iq-sub-card" style="background-color:#323131;">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    ...
                                    <small class="font-size-12"> Price :{{ PayCurrency() }} {{ $cart->price }}
                                    </small>
                                </div>
                            </div>
                        </a>
                ...
                <a href="#" class="iq-sub-card" style="background-color:#323131;">
                    <div class="media align-items-center">
                        <div class="media-body pull-right" style="text-align:right; float:right;">
                            <span><span class="mb-0 ">Total Price :</span> <small style="font-size:15px;">
                                    {{ PayCurrency() }} {{ MyCartTotal() }} </small></span>
                        </div>
                    </div>
                </a>
            </div>

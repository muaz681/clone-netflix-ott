<template>
  ...
  <div>
    ...
    @click="sheet = !sheet"
      :size="185"
      :class="{ 'rounded-b-none shadow': sheet }"
      alt="Image"
      :src="getFile(sdata.featured.small)"
      v-if="sdata.featured && sdata.featured.small"
    />
    <img
      :data-original="$asset_url + $noimage_prot"
      :src="$asset_url + $noimage_prot"
      alt="No Image"
      class="img-fluid"
      v-else
    />
    ...
    >
      <div class="flex items-center justify-between hover-part-image">
		...
		C444.801,187.101,434.001,213.101,414.401,232.701z"
          ...
          <v-btn
            v-if="sdata.premium == 1 && sdata.video_url != null"
            class="items-center text-white justify-center cinebaz-det-fvrt"
            outlined
            fab
            color="white"
